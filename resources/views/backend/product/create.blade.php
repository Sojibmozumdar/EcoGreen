...
@section('content')
    <div class="ecogreen-category-form">
        ...
        <style>
            ...
            .btn-eco {
                background: linear-gradient(135deg, #1a5d42, #062c21);
                /* dark → main */
                color: #ffffff;
                border: none;
                border-radius: 30px;
        ...
        <div class="form-box">
            ...
            <h5 class="form-title">Add New Product</h5>
            ...
            <form action="{{ route('product.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <select id="sub-category-select" name="sub_category_id"
                        ...
                        @if (old('category_id') && $sub_categories)
                            @foreach ($sub_categories as $sub)
                                @if ($sub->category_id == old('category_id'))
                                    <option value="{{ $sub->id }}"
                ...
                <div class="mb-3">
                    ...
                    <textarea name="product_details" class="form-control">{{ old('product_details') }}</textarea>
                </div>

                {{-- Policies --}}
                <div class="mb-3">
                    <label class="form-label">Delivery Policy</label>
                    <textarea name="delivery_policy" class="form-control">{{ old('delivery_policy') }}</textarea>
                </div>

                <div class="mb-3">
                    <label class="form-label">Return Policy</label>
                    <textarea name="return_policy" class="form-control">{{ old('return_policy') }}</textarea>
                </div>
